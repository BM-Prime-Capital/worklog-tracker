...
import { Lock, Eye, EyeOff, CheckCircle, AlertCircle, ArrowLeft, Building2, Users, BarChart3, ArrowRight } from 'lucide-react'
...
function SetPasswordContent() {
  ...
  const handleInputChange = (field: keyof SetPasswordForm, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setErrors({ submit: result.message || 'Failed to set password' })
      }
    } catch (error) {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            This invitation link is invalid or has expired. Please contact your manager for a new invitation.
          </p>
          <Link
            href="/auth/login"
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 text-white p-12 flex-col justify-between h-screen overflow-hidden">
        ...
        <div>
          ...
          <p className="text-blue-100 text-lg leading-relaxed">
            Complete your account setup to start tracking your work, 
            collaborating with your team, and accessing your personalized dashboard.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-100">Work seamlessly with your team members and managers</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">Work Tracking</h3>
              <p className="text-blue-100">Track your daily activities and monitor productivity</p>
            </div>
          </div>
        </div>

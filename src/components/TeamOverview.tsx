      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
            ...
            <span className="text-lg font-semibold text-green-600">{Math.round(totalHours)}h</span>
          </div>
          ...
          <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
            ...
            <span className="text-lg font-semibold text-purple-600">{Math.round(averageHours)}h</span>
          </div>
        </div>
      )}
    </div>
